...
uint8  zclSampleLight_LevelOnLevel = ATTR_DEFAULT_LEVEL_ON_LEVEL;
uint16 zclSampleLight_LevelOnTransitionTime = 50;
uint16 zclSampleLight_LevelOffTransitionTime = 100;
